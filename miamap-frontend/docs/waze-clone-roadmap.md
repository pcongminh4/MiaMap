...
*   **Mục tiêu**: Thiết kế UI trực quan nhất để gửi báo cáo chỉ với 1-2 lần chạm khi lái xe.
...
*   **Mục tiêu**: Hiển thị trực quan nhất tình trạng đường đi (thông thoáng hay kẹt xe).
*   **Mã nguồn sửa đổi**:
    *   `[MODIFY]` [HomeMap.tsx](file:///c:/github-projects/MiaMap/miamap-frontend/src/features/home/components/HomeMap.tsx):
...
*   **Mục tiêu**: Trải nghiệm dẫn đường tự nhiên, hiển thị vị trí của những người dùng khác.
*   **Mã nguồn phát triển**:
...
*   **UI/UX**:
    *   Khi gõ tìm kiếm "matcha latte" hoặc "cà phê sữa đá", danh sách kết quả (Search Panel) sẽ không chỉ hiển thị tên cửa hàng, mà hiển thị thẻ chi tiết các món nước khớp với từ khóa kèm giá cả bên dưới mỗi cửa hàng.
...
*   **Luồng xử lý (Integration)**:
    ...
    3.  Nhận phản hồi từ trợ lý AI, hiển thị câu trả lời dạng bong bóng chat: *"Tôi tìm thấy 3 quán cà phê bán Matcha Latte gần bạn nhất. Quán X cách 500m được đánh giá 4.8 sao..."*.
