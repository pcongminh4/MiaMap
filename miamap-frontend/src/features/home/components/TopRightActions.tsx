...
export function TopRightActions() {
  return (
    <div className="absolute right-3 top-3 z-20 flex items-center gap-2 md:right-6 md:top-7 md:gap-3">
      <button type="button" className="grid h-10 w-10 place-items-center rounded-full bg-white text-slate-700 shadow-lg transition hover:scale-[1.02] md:h-14 md:w-14" aria-label="Ứng dụng">
      ...
      <button type="button" className="grid h-10 w-10 place-items-center rounded-full bg-white text-slate-700 shadow-lg transition hover:scale-[1.02] md:h-14 md:w-14" aria-label="Tùy chọn khác">
